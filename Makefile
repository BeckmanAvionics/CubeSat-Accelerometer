...
TESTCSRCS= src/IMU.cpp
TESTCSRCS+= src/helloWorld.cpp

TESTAPPS= $(patsubst src/%.cpp,bin/%,$(filter src/%.cpp,$(TESTCSRCS)))
TESTAPPS+= $(patsubst %.cpp,%,$(filter %.cpp,$(filter-out src/%.cpp,$(TESTCSRCS))))
